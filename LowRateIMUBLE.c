...
void init_icm45605(void)
{
    ...
    inv_imu_set_accel_frequency(&imu_dev, ACCEL_CONFIG0_ACCEL_ODR_12_5_HZ);
    inv_imu_set_gyro_frequency(&imu_dev, GYRO_CONFIG0_GYRO_ODR_12_5_HZ);
...
static void imuble_task(void *pvParameters)
{
    ...
    init_icm45605();
        ...
        Display_printf(displayHandle, 0, 0, "working");
    ...
    for (;;)
    {
        ...
        Display_printf(displayHandle, 0, 0, "works!");
